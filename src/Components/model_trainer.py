...
class ModelTrainer:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.train_data = self.config.yaml_config['model_trainer']['preprocessed_train_data']
            self.test_data = self.config.yaml_config['model_trainer']['preprocessed_test_data']
    ...
    def objective(self, trial, X_train, y_train, X_test, y_test):
        ...
        # Instantiate the classifier with suggested hyperparameters
    ...
    def fine_tune_model(self, X_train, X_test, y_train, y_test):
        ...
        try:
            ...
            study.optimize(lambda trial: self.objective(trial, X_train, X_test, y_train, y_test), n_trials=100)  # You can adjust the number of trials as needed
            best_study = study.best_trial
            print('Accuracy: {}'.format(best_study.value))
            print("Best hyperparameters: {}".format(best_study.params))
    ...
    def train_final_model(self, X, y, best_params):
        ...
        try:
            ...
            best_classifier.fit(X, y)  # Use the entire dataset for training
